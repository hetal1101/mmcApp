...
public class TutorialSuccessActivity extends AppCompatActivity {
    ...
    String resMessage = "", resCode = "", UserId = "", tutorialID = "",tutorial_name = "";

    TextView tvTitle;

    ImageView ivBack;

    String point_text = "0", heading = "", song_name = "", share = "", best_score = "", rate = "0",user_coin="",user_level_title="",user_level="0",coins="",user_level_total="0";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
            context = this;
        setTheme(Util.getTheme(context));             setContentView(      R.layout.activity_tutorial_success);
        ...
        ivRetry.setOnClickListener(view -> {
            ...
            i.putExtra("tutorialCategoryId", tutorialID);
            i.putExtra("tutorialCategoryName", tutorial_name);
            startActivity(i);
            finish();
        });
        ...
        ll2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(context, TutorialPlayAlongActivity.class);
                i.putExtra("tutorialID", tutorialID);
                i.putExtra("tutorial_name", tutorial_name);
                startActivity(i);
                finish();
            }
        });
    ...
    private class SongCompleteData extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if (resCode.equalsIgnoreCase("0")) {
                ...
                builder.start();
                count_animation_textView.setAnimationDuration(1500).countAnimation(0, Integer.parseInt(point_text.equalsIgnoreCase("")?"0":point_text));
