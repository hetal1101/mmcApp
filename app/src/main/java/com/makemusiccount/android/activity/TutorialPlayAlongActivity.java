...
public class TutorialPlayAlongActivity extends AppCompatActivity implements OnPianoListener,
    ...
    String resMessage = "",songID="", resCode = "", tutorial_name = "", song_file = "", tutorialID = "", image = "", artist = "";
    ...
    LinearLayout tvNext,llCounterBg;
    Global global;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
            context = this;
        setTheme(Util.getTheme(context));             setContentView(      R.layout.activity_tutorial_play_along);
        ...
        initComp();
        TutorialPlayAlongActivity.setPianoClickListener(Position ->{
        ...
        if (bundle != null) {
            tutorial_name = bundle.getString("tutorial_name", "");
            tutorialID = bundle.getString("tutorialID", "");
            songID = bundle.getString("songID", "");
            tvName.setText(tutorial_name);
        }
    ...
    static com.makemusiccount.android.listener.onPianoClickListener onPianoClickListener;
    ...
    private class AutoPlayKey extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            String strAPI = AppConstant.API_TUTORIAL_AUTO_PLAY_KEY + Util.getUserId(context)
    ...
    private void goToSongList() {
        if ((System.currentTimeMillis() - exitTime) > 2000) {
            Toast.makeText(this, R.string.press_again_to_go_tutorial_list, Toast.LENGTH_SHORT).show();
