...
import com.makemusiccount.android.activity.WebViewActivity;
...
public class Subscrption_new extends Fragment {


    public Subscrption_new() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_subscrption_new, container, false);
        context=getActivity();
        ...
        if(isTablet(context))
        {
            llbg1=view.findViewById(R.id.llbackgrond1);
            llbg2=view.findViewById(R.id.llbackground2);
            llel1=view.findViewById(R.id.llelevation1);
            llel2=view.findViewById(R.id.llelevation2);
      ...
      /*  if (Util.getUserId(context) == null) {
        ...
        freeTextview=view.findViewById(R.id.freeTextview);
        paidTextview=view.findViewById(R.id.paidTextview);

        paidLL=view.findViewById(R.id.paidLL);
        ...
        freeLL=view.findViewById(R.id.freeLL);
    ...
    private void initComp(View view) {
        ...
        tvHeading = view.findViewById(R.id.tvsubhead);
        tvSubHeading = view.findViewById(R.id.tvhead);
        tvPoint1 = view.findViewById(R.id.tvPoint1);
        tvPoint2 = view.findViewById(R.id.tvPoint2);
        tvPoint3 = view.findViewById(R.id.tvPoint3);
        main_subheader = view.findViewById(R.id.main_subheader);
        main_header = view.findViewById(R.id.main_header);
    ...
    public void doExitApp() {
        if ((System.currentTimeMillis() - exitTime) > 2000) {
            Toast.makeText(getActivity(), "Press Again For Open Dashboard", Toast.LENGTH_SHORT).show();
