...
import com.makemusiccount.android.activity.MembershipActivity;
...
public class ProfileFragment extends Fragment {
    ...
    private void initComp(View view) {
        ...
        llProfileView = view.findViewById(R.id.llProfileView);
        llPasswordView = view.findViewById(R.id.llPasswordView);
        imgUpdateImage = view.findViewById(R.id.imgUpdateimage);
        imgChangeImage = view.findViewById(R.id.imgChangeImage);
        showHideCPassword = view.findViewById(R.id.showHideCPassword);
        showHideNPassword = view.findViewById(R.id.showHideNPassword);
        showHideRPassword = view.findViewById(R.id.showHideRPassword);
