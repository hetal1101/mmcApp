...
public class KeyboardAdapter1 extends RecyclerView.Adapter<KeyboardAdapter1.ViewHolder> {
...
int ll=0;
    ...
    public KeyboardAdapter1(Activity context, List<ThemeList> bean, int ll) {
        this.listData = bean;
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        if(Util.getUSER_KEYBOARD(context).equalsIgnoreCase(bean.getUsershopID()))
        {
        ...
        else
        {
         ...
         if(Util.getUSER_KEYBOARD(context).equalsIgnoreCase("")&& position==0)
            {
                holder.aa.setVisibility(View.VISIBLE);
            }
        ...
        holder.llMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                openPopup(position,listData.get(position).getUsershopID());
    ...
    AlertDialog dialog;
    private void openPopup(int pos,String shopID) {
