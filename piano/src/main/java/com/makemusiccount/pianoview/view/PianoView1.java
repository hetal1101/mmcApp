...
public class PianoView1 extends View {
    private final static String TAG = "PianoView1";
    private Piano piano = null;
    public int whitekey=4;
    ...
    public boolean autoplayclickview=false;
    ...
    public static final int HANDLE_AUTO_PLAY_WHITE_DOWN = 3;
    private static final int HANDLE_AUTO_PLAY_KEY_UP = 4;
    int paddingToTopBlack, paddingToBottomBlack;

    public PianoView1(Context context) {
        this(context, null);
    }

    public PianoView1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PianoView1(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        if (piano == null) {
            ...
            piano = new Piano(context, scale, maxRange,numShow,whitekey);
