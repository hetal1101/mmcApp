...
public class PianoViewSoundCheck extends View {
    ...
    public PianoViewSoundCheck(Context context) {
        this(context, null);
    }

    public PianoViewSoundCheck(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PianoViewSoundCheck(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        if (piano == null) {
            ...
            piano = new Piano(context, scale, maxRange,3,3);
